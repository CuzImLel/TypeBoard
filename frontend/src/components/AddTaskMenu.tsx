...
const AddTaskMenu: React.FC<props> = ({
  board,
  setTaskCreateMenu,
  reloadTasks,
}) => {
        ...
        <div className="add_task_menu_content">
          <div className="add_task_menu_top">
            ...
            <span
              ...
              onClick={() => setTaskCreateMenu(false)}
            >
              close
            </span>
          </div>
            ...
            <form>
              ...
              <li>
                ...
                <input
                  type="text"
                  required
                  placeholder="Type in your task description!"
                  value={description}
                  onChange={(e) => {
              ...
              <li>
                ...
                <div className="create_task_state_selector">
                  <div
                    className="create_task_state_remaining"
                    id="task_state"
                  ...
                  <div
                    className="create_task_state_progress"
                    id="task_state"
                  ...
                  <div
                    className="create_task_state_finished"
                    id="task_state"
